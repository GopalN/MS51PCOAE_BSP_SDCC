...
;------------------------------------------------------------
	G$putchar$0$0 ==.
	C$PUTCHAR.C$39$0_0$49 ==.
;	..\PUTCHAR.C:39: int putchar (int c)  {
;	-----------------------------------------
;	 function putchar
;	-----------------------------------------
_putchar:
	...
	ar0 = 0x00
	mov	r6,dpl
	C$PUTCHAR.C$40$1_0$49 ==.
;	..\PUTCHAR.C:40: while (!TI);
00101$:
	C$PUTCHAR.C$41$1_0$49 ==.
;	..\PUTCHAR.C:41: TI = 0;
;	assignBit
	jbc	_TI,00114$
	sjmp	00101$
00114$:
	C$PUTCHAR.C$42$1_0$49 ==.
;	..\PUTCHAR.C:42: return (SBUF = c);
	mov	_SBUF,r6
	mov	r7,#0x00
	mov	dpl,r6
	mov	dph,r7
	C$PUTCHAR.C$43$1_0$49 ==.
;	..\PUTCHAR.C:43: }
	C$PUTCHAR.C$43$1_0$49 ==.
	XG$putchar$0$0 ==.
	ret
