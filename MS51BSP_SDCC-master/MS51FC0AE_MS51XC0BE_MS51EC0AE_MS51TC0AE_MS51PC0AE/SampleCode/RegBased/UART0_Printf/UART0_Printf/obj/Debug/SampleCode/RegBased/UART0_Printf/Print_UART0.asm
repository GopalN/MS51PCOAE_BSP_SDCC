...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$Print_UART0.C$19$0_0$53 ==.
;	..\Print_UART0.C:19: void main (void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	ar1 = 0x01
	ar0 = 0x00
	C$Print_UART0.C$24$1_0$53 ==.
;	..\Print_UART0.C:24: MODIFY_HIRC(HIRC_24);
	mov	_SFRS,#0x00
	anl	_P0M1,#0xbf
	anl	_P0M2,#0xbf
	C$Print_UART0.C$25$1_0$53 ==.
;	..\Print_UART0.C:25: UART_Open(24000000,UART0_Timer3,115200);
	mov	dpl,#0x06
	lcall	_MODIFY_HIRC
	C$Print_UART0.C$26$1_0$53 ==.
;	..\Print_UART0.C:26: ENABLE_UART0_PRINTF;                              // Important! use prinft function must set TI=1;
	...
	mov	a,#0x01
	lcall	_UART_Open
	C$Print_UART0.C$27$1_0$53 ==.
;	..\Print_UART0.C:27: 
	orl	_SCON,#0x02
;	assignBit
	setb	_PRINTFG
	C$Print_UART0.C$29$1_0$53 ==.
;	..\Print_UART0.C:29: {
00102$:
	C$Print_UART0.C$31$2_0$54 ==.
;	..\Print_UART0.C:31: printf("\n Hello world!");
	orl	_SCON,#0x02
;	assignBit
	setb	_PRINTFG
	C$Print_UART0.C$32$2_0$54 ==.
;	..\Print_UART0.C:32: DISABLE_UART0_PRINTF;
	mov	a,#___str_0
	push	acc
	mov	a,#(___str_0 >> 8)
	push	acc
	...
	dec	sp
	dec	sp
	C$Print_UART0.C$33$2_0$54 ==.
;	..\Print_UART0.C:33: Timer0_Delay(24000000,300,1000);
	anl	_SCON,#0xfd
;	assignBit
	clr	_PRINTFG
	C$Print_UART0.C$34$2_0$54 ==.
;	..\Print_UART0.C:34: }
	mov	_Timer0_Delay_PARM_2,#0x2c
	mov	(_Timer0_Delay_PARM_2 + 1),#0x01
	...
	lcall	_Timer0_Delay
	sjmp	00102$
	C$Print_UART0.C$36$1_0$53 ==.
;	..\Print_UART0.C:36: ERROR: no line number 36 in file ..\Print_UART0.C
	C$Print_UART0.C$36$1_0$53 ==.
	XG$main$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
FPrint_UART0$__str_0$0_0$0 == .
	.area CONST   (CODE)
___str_0:
	.db 0x0a
	.ascii " Hello world!"
