...
;--------------------------------------------------------
	.area BSEG    (BIT)
G$ADC_CONT_FINAL_FLAG$0_0$0==.
_ADC_CONT_FINAL_FLAG::
	.ds 1
;--------------------------------------------------------
...
;------------------------------------------------------------
	G$putchar$0$0 ==.
	C$ADC_simple.C$26$0_0$60 ==.
;	..\ADC_simple.C:26: int putchar (int c)  {
;	-----------------------------------------
;	 function putchar
;	-----------------------------------------
_putchar:
	...
	ar0 = 0x00
	mov	r6,dpl
	C$ADC_simple.C$27$1_0$60 ==.
;	..\ADC_simple.C:27: while (!TI);
00101$:
	C$ADC_simple.C$28$1_0$60 ==.
;	..\ADC_simple.C:28: TI = 0;
;	assignBit
	jbc	_TI,00114$
	sjmp	00101$
00114$:
	C$ADC_simple.C$29$1_0$60 ==.
;	..\ADC_simple.C:29: return (SBUF = c);
	mov	_SBUF,r6
	mov	r7,#0x00
	mov	dpl,r6
	mov	dph,r7
	C$ADC_simple.C$30$1_0$60 ==.
;	..\ADC_simple.C:30: }
	C$ADC_simple.C$30$1_0$60 ==.
	XG$putchar$0$0 ==.
	ret
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$ADC_simple.C$32$1_0$62 ==.
;	..\ADC_simple.C:32: void main (void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$ADC_simple.C$41$1_0$62 ==.
;	..\ADC_simple.C:41: MODIFY_HIRC(HIRC_24);
	mov	dpl,#0x06
	lcall	_MODIFY_HIRC
	C$ADC_simple.C$42$1_0$62 ==.
;	..\ADC_simple.C:42: P06_PUSHPULL_MODE;
	mov	_SFRS,#0x00
	anl	_P0M1,#0xbf
	orl	_P0M2,#0x40
	C$ADC_simple.C$43$1_0$62 ==.
;	..\ADC_simple.C:43: P21_INPUT_MODE;
	mov	_SFRS,#0x02
	orl	_P2M1,#0x02
	anl	_P2M2,#0xfd
	C$ADC_simple.C$44$1_0$62 ==.
;	..\ADC_simple.C:44: UART_Open(24000000,UART0_Timer3,115200);
	...
	mov	a,#0x01
	lcall	_UART_Open
	C$ADC_simple.C$45$1_0$62 ==.
;	..\ADC_simple.C:45: ENABLE_UART0_PRINTF;
	orl	_SCON,#0x02
;	assignBit
	setb	_PRINTFG
	C$ADC_simple.C$47$1_0$62 ==.
;	..\ADC_simple.C:47: ENABLE_ADC_CH9;
	mov	_SFRS,#0x02
	orl	_P2M1,#0x02
	anl	_P2M2,#0xfd
	mov	_SFRS,#0x00
	...
	mov	_SFRS,#0x00
	orl	_ADCCON1,#0x01
	C$ADC_simple.C$49$1_0$62 ==.
;	..\ADC_simple.C:49: while(1)
00105$:
	C$ADC_simple.C$51$2_0$63 ==.
;	..\ADC_simple.C:51: Timer2_Delay(24000000,128,300,1000);;
	mov	_Timer2_Delay_PARM_2,#0x80
	mov	(_Timer2_Delay_PARM_2 + 1),#0x00
	mov	_Timer2_Delay_PARM_3,#0x2c
	mov	(_Timer2_Delay_PARM_3 + 1),#0x01
	mov	_Timer2_Delay_PARM_4,#0xe8
	mov	(_Timer2_Delay_PARM_4 + 1),#0x03
	clr	a
	mov	(_Timer2_Delay_PARM_4 + 2),a
	mov	(_Timer2_Delay_PARM_4 + 3),a
	mov	dptr,#0x3600
	mov	b,#0x6e
	mov	a,#0x01
	lcall	_Timer2_Delay
	C$ADC_simple.C$52$2_0$63 ==.
;	..\ADC_simple.C:52: clr_ADCCON0_ADCF;
	anl	_ADCCON0,#0x7f
	C$ADC_simple.C$53$2_0$63 ==.
;	..\ADC_simple.C:53: set_ADCCON0_ADCS;                  // ADC start trig signal
	orl	_ADCCON0,#0x40
	C$ADC_simple.C$54$2_0$63 ==.
;	..\ADC_simple.C:54: while(ADCF == 0);
00101$:
	jnb	_ADCF,00101$
	C$ADC_simple.C$55$2_0$63 ==.
;	..\ADC_simple.C:55: temp=(ADCRH<<4)+(ADCRL&0x0F);
	mov	r6,_ADCRH
	clr	a
	swap	a
	anl	a,#0xf0
	...
	addc	a,r7
	mov	r7,a
	C$ADC_simple.C$56$2_0$63 ==.
;	..\ADC_simple.C:56: printf ("\n ADC Value = 0x%02X", temp);
	push	ar6
	push	ar7
	mov	a,#___str_0
	push	acc
	...
	add	a,#0xfb
	mov	sp,a
	C$ADC_simple.C$57$2_0$63 ==.
;	..\ADC_simple.C:57: P35 ^= 1;
	cpl	_P35
	sjmp	00105$
	C$ADC_simple.C$59$1_0$62 ==.
;	..\ADC_simple.C:59: }
	C$ADC_simple.C$59$1_0$62 ==.
	XG$main$0$0 ==.
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
FADC_simple$__str_0$0_0$0 == .
	.area CONST   (CODE)
___str_0:
	.db 0x0a
	.ascii " ADC Value = 0x%02X"
	.db 0x00
	.area CSEG    (CODE)
	.area XINIT   (CODE)
	.area CABS    (ABS,CODE)
