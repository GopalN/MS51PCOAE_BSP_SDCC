...
;--------------------------------------------------------
	.globl _ADC_ConvertTime_PARM_3
	.globl _ADC_ConvertTime_PARM_2
	.globl _ADC_InitialContinous_PARM_2
	.globl _MOSI
	.globl _P00
	.globl _MISO
	.globl _P01
...
;--------------------------------------------------------
	.area	OSEG    (OVR,DATA)
Ladc.ADC_InitialContinous$u8ADCRLength$1_0$55==.
_ADC_InitialContinous_PARM_2:
	.ds 1
	.area	OSEG    (OVR,DATA)
Ladc.ADC_ConvertTime$u8ADCDIV$1_0$57==.
_ADC_ConvertTime_PARM_2:
	.ds 1
Ladc.ADC_ConvertTime$u8ADCAQT$1_0$57==.
_ADC_ConvertTime_PARM_3:
	.ds 1
	.area	OSEG    (OVR,DATA)
;--------------------------------------------------------
...
;--------------------------------------------------------
	.area CSEG    (CODE)
;------------------------------------------------------------
;Allocation info for local variables in function 'ADC_InitialContinous'
;------------------------------------------------------------
;u8ADCRLength              Allocated with name '_ADC_InitialContinous_PARM_2'
;u16ADCRBase               Allocated to registers r6 r7 
;------------------------------------------------------------
	G$ADC_InitialContinous$0$0 ==.
	C$adc.c$27$0_0$56 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:27: void ADC_InitialContinous(unsigned int u16ADCRBase, unsigned char u8ADCRLength)
;	-----------------------------------------
;	 function ADC_InitialContinous
;	-----------------------------------------
_ADC_InitialContinous:
	ar7 = 0x07
	ar6 = 0x06
	ar5 = 0x05
	ar4 = 0x04
	...
	mov	r7,dph
	C$adc.c$29$1_0$56 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:29: SFRS=2;
	mov	_SFRS,#0x02
	C$adc.c$30$1_0$56 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:30: ADCBAL=u16ADCRBase;
	mov	_ADCBAL,r6
	C$adc.c$31$1_0$56 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:31: ADCBAH = u16ADCRBase>>8;
	mov	_ADCBAH,r7
	C$adc.c$32$1_0$56 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:32: ADCSN  = u8ADCRLength - 1;   //Offset value, since the actually sampling number= ADCSN[7:0] + 1
	mov	a,_ADC_InitialContinous_PARM_2
	dec	a
	mov	_ADCSN,a
	C$adc.c$33$1_0$56 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:33: SFRS = 0;
	mov	_SFRS,#0x00
	C$adc.c$34$1_0$56 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:34: }
	C$adc.c$34$1_0$56 ==.
	XG$ADC_InitialContinous$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'ADC_ConvertTime'
;------------------------------------------------------------
;u8ADCDIV                  Allocated with name '_ADC_ConvertTime_PARM_2'
;u8ADCAQT                  Allocated with name '_ADC_ConvertTime_PARM_3'
;u8AINCHNSEL               Allocated to registers r7 
;------------------------------------------------------------
	G$ADC_ConvertTime$0$0 ==.
	C$adc.c$45$1_0$58 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:45: void ADC_ConvertTime(unsigned char u8AINCHNSEL, unsigned char u8ADCDIV, unsigned char u8ADCAQT)
;	-----------------------------------------
...
_ADC_ConvertTime:
	mov	r7,dpl
	C$adc.c$47$1_0$58 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:47: SFRS=0;
	mov	_SFRS,#0x00
	C$adc.c$48$1_0$58 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:48: ADCSR &= 0x8F;
	anl	_ADCSR,#0x8f
	C$adc.c$49$1_0$58 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:49: ADCSR |= (u8ADCDIV&0x07)<<4;
	...
	mov	_ADCSR,a
	C$adc.c$50$1_0$58 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:50: switch (u8AINCHNSEL)
	mov	a,r7
	add	a,#0xff - 0x0f
	jnc	00124$
	ljmp	00117$
...
00126$:
	...
	.db	00116$>>8
	C$adc.c$60$2_0$59 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:60: case ADC_BANDGAP:
00109$:
	C$adc.c$61$2_0$59 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:61: ADCCON2&=0xF1;
	anl	_ADCCON2,#0xf1
	C$adc.c$62$2_0$59 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:62: ADCCON2|=(u8ADCAQT&0x07)<<1;
	mov	a,_ADC_ConvertTime_PARM_3
	anl	a,#0x07
	add	a,acc
	mov	r7,a
	mov	r6,_ADCCON2
	...
	mov	_ADCCON2,a
	C$adc.c$63$2_0$59 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:63: break;
	C$adc.c$71$2_0$59 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:71: case ADC_CH15:
	sjmp	00117$
00116$:
	C$adc.c$72$2_0$59 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:72: SFRS = 2;
	mov	_SFRS,#0x02
	C$adc.c$73$2_0$59 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:73: ADCCON3&=0xF1;
	anl	_ADCCON3,#0xf1
	C$adc.c$74$2_0$59 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:74: ADCCON3|=(u8ADCAQT&0x07)<<1;
	mov	a,_ADC_ConvertTime_PARM_3
	anl	a,#0x07
	add	a,acc
	mov	r7,a
	...
	mov	_ADCCON3,a
	C$adc.c$76$1_0$58 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:76: }
00117$:
	C$adc.c$77$1_0$58 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:77: SFRS = 0;
	mov	_SFRS,#0x00
	C$adc.c$78$1_0$58 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:78: }
	C$adc.c$78$1_0$58 ==.
...
;------------------------------------------------------------
;BandgapHigh               Allocated to registers r6 
;BandgapLow                Allocated to registers r7 
;u16bgvalue                Allocated to registers 
;------------------------------------------------------------
	G$READ_BANDGAP$0$0 ==.
	C$adc.c$86$1_0$60 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:86: unsigned int READ_BANDGAP()
;	-----------------------------------------
;	 function READ_BANDGAP
;	-----------------------------------------
_READ_BANDGAP:
	C$adc.c$90$1_0$60 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:90: set_CHPCON_IAPEN;
	mov	_SFRS,#0x00
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
...
;	assignBit
	...
	mov	_EA,c
	C$adc.c$91$1_0$60 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:91: IAPCN = READ_UID;
	mov	_IAPCN,#0x04
	C$adc.c$92$1_0$60 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:92: IAPAL = 0x0d;
	mov	_IAPAL,#0x0d
	C$adc.c$93$1_0$60 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:93: IAPAH = 0x00;
	mov	_IAPAH,#0x00
	C$adc.c$94$1_0$60 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:94: set_IAPTRG_IAPGO;
	mov	_SFRS,#0x00
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
...
;	assignBit
	...
	mov	_EA,c
	C$adc.c$95$1_0$60 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:95: BandgapLow = IAPFD&0x0F;
	mov	a,_IAPFD
	anl	a,#0x0f
	mov	r7,a
	C$adc.c$96$1_0$60 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:96: IAPAL = 0x0C;
	mov	_IAPAL,#0x0c
	C$adc.c$97$1_0$60 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:97: IAPAH = 0x00;
	mov	_IAPAH,#0x00
	C$adc.c$98$1_0$60 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:98: set_IAPTRG_IAPGO;
	mov	_SFRS,#0x00
;	assignBit
	mov	c,_EA
	mov	_BIT_TMP,c
...
;	assignBit
	...
	mov	_EA,c
	C$adc.c$99$1_0$60 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:99: BandgapHigh = IAPFD;
	mov	r6,_IAPFD
	C$adc.c$100$1_0$60 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:100: u16bgvalue = (BandgapHigh<<4)+BandgapLow;
	clr	a
	swap	a
	anl	a,#0xf0
	xch	a,r6
	...
	mov	dph,a
	C$adc.c$101$1_0$60 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:101: clr_CHPCON_IAPEN;
...
;	assignBit
	...
	mov	_EA,c
	C$adc.c$102$1_0$60 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:102: return (u16bgvalue);
	C$adc.c$103$1_0$60 ==.
;	..\..\..\..\Library\StdDriver\src\adc.c:103: }
	C$adc.c$103$1_0$60 ==.
	XG$READ_BANDGAP$0$0 ==.
	ret
	.area CSEG    (CODE)
